...
public static class UnitRegistry
{
    ...
    {
        // ── Core units ──────────────────────────────────────────────────────────
        // BAL.combat: attack intervals retuned toward AoE2 rhythm (Militia 2.03,
        // Archer 2.03, Knight 1.8, Spearman 3.05 ...) so fights stop melting in seconds;
        // counter bonuses lifted to AoE2 base values (Spearman +15, Camel +9).
        [UnitType.Militia]       = new UnitRow(5f,  1.3f, 1.9f, 7f,  ArmorClass.Infantry, DamageType.Melee,  false),
        [UnitType.Archer]        = new UnitRow(4f,  6.5f, 1.9f, 9f,  ArmorClass.Archer,   DamageType.Pierce, true),
        [UnitType.Cavalry]       = new UnitRow(8f,  1.4f, 1.7f, 8f,  ArmorClass.Cavalry,  DamageType.Melee,  false),
        [UnitType.Trebuchet]     = new UnitRow(35f, 15f,  9.0f, 15f, ArmorClass.Siege,    DamageType.Siege,  true,  minAttackRange: 3f,  bonusVs: BV(ArmorClass.Building, 70f)),
        [UnitType.Spearman]      = new UnitRow(4f,  1.5f, 2.6f, 7f,  ArmorClass.Infantry, DamageType.Melee,  false, bonusVs: BV(ArmorClass.Cavalry, 15f)),
        [UnitType.Longbowman]    = new UnitRow(5f,  8.5f, 1.9f, 11f, ArmorClass.Archer,   DamageType.Pierce, true),
        [UnitType.Galley]        = new UnitRow(8f,  5.5f, 3.0f, 8f,  ArmorClass.Ship,     DamageType.Pierce, true,  minAttackRange: 1.5f),
        [UnitType.Skirmisher]    = new UnitRow(3f,  5f,   2.8f, 9f,  ArmorClass.Archer,   DamageType.Pierce, true,  bonusVs: BV(ArmorClass.Archer, 3f)),
        [UnitType.Camel]         = new UnitRow(7f,  1.4f, 1.8f, 8f,  ArmorClass.Cavalry | ArmorClass.Camel, DamageType.Melee, false, bonusVs: BV(ArmorClass.Cavalry, 9f)),
        [UnitType.Ram]           = new UnitRow(4f,  1.3f, 5.0f, 4f,  ArmorClass.Siege,    DamageType.Siege,  false, bonusVs: BV(ArmorClass.Building, 40f)),
        [UnitType.Mangonel]      = new UnitRow(25f, 9f,   5.5f, 11f, ArmorClass.Siege,    DamageType.Siege,  true,  minAttackRange: 2f, splashRadius: 1.8f),
        [UnitType.Scorpion]      = new UnitRow(4f,  5.5f, 3.6f, 9f,  ArmorClass.Siege,    DamageType.Pierce, true,  minAttackRange: 1.5f, splashRadius: 1.2f, bonusVs: BV(ArmorClass.Infantry, 6f)),
        ...
        [UnitType.Samurai]       = new UnitRow(9f,  1.2f, 1.9f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false),
        [UnitType.Eagle]         = new UnitRow(7f,  1.3f, 2.0f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false),
        [UnitType.EliteEagle]    = new UnitRow(9f,  1.3f, 1.9f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false),
        // ── N4/CIVU ────────────────────────────────────────────────────────────
        [UnitType.ThrowingAxeman]= new UnitRow(9f,  3f,   2.0f, 9f,  ArmorClass.Infantry, DamageType.Melee,  true),
        [UnitType.Cataphract]    = new UnitRow(10f, 1.4f, 1.8f, 8f,  ArmorClass.Cavalry,  DamageType.Melee,  false, bonusVs: BV(ArmorClass.Infantry, 12f)),
        [UnitType.Berserk]       = new UnitRow(9f,  1.3f, 1.9f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false, selfRegen: 0.6f),
        [UnitType.Mameluke]      = new UnitRow(8f,  3f,   2.0f, 9f,  ArmorClass.Cavalry | ArmorClass.Camel, DamageType.Melee, true, bonusVs: BV(ArmorClass.Cavalry, 9f)),
        // ── N4/CIVC13 ──────────────────────────────────────────────────────────
        [UnitType.WoadRaider]    = new UnitRow(8f,  1.3f, 1.9f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false),
        [UnitType.ChuKoNu]       = new UnitRow(8f,  6f,   1.6f, 10f, ArmorClass.Archer,   DamageType.Pierce, true),
        [UnitType.Huskarl]       = new UnitRow(10f, 1.3f, 1.9f, 8f,  ArmorClass.Infantry, DamageType.Melee,  false, bonusVs: BV(ArmorClass.Archer, 6f)),
