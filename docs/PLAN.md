...
**Faz P3 — İçerik Araçları 🗑️ SİLİNDİ (2026-06-14):**
- TriggerSystem, CampaignSystem, CampaignScreen, TutorialSystem, ScenarioEditor oluşturuldu ve
  ardından **MP-only pivot** kararıyla tamamen silindi. Commit `ea74d7f`.
- Oyun artık saf multiplayer odaklı — SP campaign/tutorial sistemi yok.
